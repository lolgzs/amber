...
unescape('_pre_'),
smalltalk.method({
selector: unescape('pre%3A'),
category: 'tags',
fn: function (anObject) {
    var self = this;
    return smalltalk.send(smalltalk.send(self, "_pre", []), "_with_", [anObject]);
    return self;
},
args: ["anObject"],
source: unescape('pre%3A%20anObject%0A%20%20%20%20%5Eself%20pre%20with%3A%20anObject'),
messageSends: ["with:", "pre"],
referencedClasses: []
}),
smalltalk.HTMLCanvas);
