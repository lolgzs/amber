...
fn: function (aString, html) {
    ...
    CodeMirror.fromTextArea(aTextArea, {lineNumbers: true, mode: "text/x-java", enterMode: "classic", theme: "neat", matchBrackets: true, electricChars: false});
    return self;
},
args: ["aString", "html"],
...
fn: function (html) {
    var self = this;
    ($receiver = smalltalk.send(self, "_title", [])) != nil &&
        $receiver != undefined ? function () {return smalltalk.send(html, "_h1_", [smalltalk.send(self, "_title", [])]);}() : nil;
...
fn: function () {
    var self = this;
    return unescape("%0A%09font-size%3A%202em%3B%0A%09background%3A%20rgb%28216%2C216%2C216%29%20url%28iae/images/ci.png%29%20no-repeat%20center%20center%3B");
    return self;
},
args: [],
source: unescape('style%0A%09%5E%20%27%0A%09font-size%3A%202em%3B%0A%09background%3A%20rgb%28216%2C216%2C216%29%20url%28iae/images/ci.png%29%20no-repeat%20center%20center%3B%27'),
messageSends: [],
referencedClasses: []
}),
smalltalk.IAEContinuousIntegration);
...
fn: function () {
    var self = this;
    return unescape("background%3A%20rgb%28235%2C239%2C249%29%3B");
    return self;
},
args: [],
source: unescape('style%0A%09%5E%20%27background%3A%20rgb%28235%2C239%2C249%29%3B%27'),
messageSends: [],
referencedClasses: []
}),
smalltalk.IAETracker);
...
fn: function () {
    var self = this;
    return [smalltalk.IAEIntroSlide || IAEIntroSlide, smalltalk.IAETDDCycle || IAETDDCycle, smalltalk.IAECalculatorTest || IAECalculatorTest, smalltalk.IAECalculatorFirstImplementation ||
        IAECalculatorFirstImplementation, smalltalk.IAECalculatorSecondTest || IAECalculatorSecondTest, smalltalk.IAECalculatorSecondImplementation ||
        IAECalculatorSecondImplementation, smalltalk.IAECalculatorRefactor || IAECalculatorRefactor, smalltalk.IAECalculatorTestJUnit4 || IAECalculatorTestJUnit4, smalltalk.IAESectionExercises || IAESectionExercises, smalltalk.IAETDDLargestExercise || IAETDDLargestExercise, smalltalk.IAETDDLargestExerciseFirstTest ||
        IAETDDLargestExerciseFirstTest, smalltalk.IAETDDLargestVideo || IAETDDLargestVideo, smalltalk.IAETDDStackExercise || IAETDDStackExercise, smalltalk.IAETDDStackFixtures || IAETDDStackFixtures, smalltalk.IAETDDTestExceptionThrown || IAETDDTestExceptionThrown, smalltalk.IAETDDTestExceptionNotThrown ||
        IAETDDTestExceptionNotThrown, smalltalk.IAETDDStackExerciseVideo || IAETDDStackExerciseVideo, smalltalk.IAETDDBookAstels || IAETDDBookAstels, smalltalk.IAETDDBookBeck || IAETDDBookBeck, smalltalk.IAETDDBookThomas || IAETDDBookThomas];
    return self;
},
args: [],
